const PrivacyPolicy = () => {
  return (
    <div className="md:mx-0 lg:mx-20">
      <div className="py-20 text-center bg-slate-200">
        <h2 className="text-bgSecondary font-fontBold text-headingSecondary lg:text-titleHeading">
          Privacy Policy
        </h2>
        <p className="text-mediumGrey">Last Updated on 27 January 2022</p>
      </div>

      <div className="text-bgSecondary mx-2 md:mx-10 lg:mx-20">
        <h2 className="text-headingSecondary text-center font-fontBold lg:text-titleHeading my-4 ">
        ...
        <h3 className="text-blogTitle font-fontBold text-center mt-6">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor.
        </h3>
